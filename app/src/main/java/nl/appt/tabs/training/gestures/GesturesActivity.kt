...
class GesturesActivity: ToolbarActivity() {
    ...
    companion object {
        ...
        private val gestures = arrayListOf(
            ...
            Gesture.TWO_FINGER_SCROLL_LEFT,
            Gesture.TWO_FINGER_SCROLL_RIGHT,
            "Verplaatsen",
            Gesture.ONE_FINGER_SWIPE_UP_DOWN,
            Gesture.ONE_FINGER_SWIPE_DOWN_UP,
            Gesture.ONE_FINGER_SWIPE_RIGHT_LEFT,
            Gesture.ONE_FINGER_SWIPE_LEFT_RIGHT,
            "Snelkoppelingen",
            Gesture.ONE_FINGER_SWIPE_DOWN_LEFT,
            Gesture.ONE_FINGER_SWIPE_UP_LEFT,
            Gesture.ONE_FINGER_SWIPE_LEFT_UP,
            Gesture.ONE_FINGER_SWIPE_RIGHT_DOWN ,
            Gesture.ONE_FINGER_SWIPE_LEFT_DOWN,
            Gesture.ONE_FINGER_SWIPE_UP_RIGHT,
            Gesture.ONE_FINGER_SWIPE_DOWN_RIGHT
        )
    }
}